...
VALUES ('comp_1', 'RouteFlow Demo Corp', 1726243200000);
...
-- 3. Retailers (Preserving ret_1, adding BEAT-04 retailers R1-R6)
...
-- 4. Products (Preserving prod_1, prod_2, adding P1-P10)
