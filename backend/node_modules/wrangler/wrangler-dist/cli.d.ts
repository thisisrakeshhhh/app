...
export { Binding, experimental_patchConfig, experimental_readRawConfig, defaultWranglerConfig as unstable_defaultWranglerConfig, getDurableObjectClassNameToUseSQLiteMap as unstable_getDurableObjectClassNameToUseSQLiteMap, printBindings as unstable_printBindings } from '@cloudflare/workers-utils';
import { Json as Json$1, WorkerdStructuredLog, DispatchFetch, Miniflare, WorkerRegistry, V4MiniflareOptions, Mutex, Response as Response$1, EmailHandlerResult, DurableObjectStorageOptions, DurableObjectStorageHandle, V4WorkerOptions, V4ModuleRule, RemoteProxyConnectionString, Request } from 'miniflare';
...
declare function deploy({ directory, accountId, projectName, branch, skipCaching, commitMessage, commitHash, commitDirty, functionsDirectory: customFunctionsDirectory, bundle, sourceMaps, args, }: PagesDeployOptions): Promise<{
    deploymentResponse: {
        ...
        latest_stage: {
            ...
            name: "queued" | "deploy" | "build" | "initialize" | "clone_repo";
...
type FetcherEmailResult = EmailHandlerResult;
